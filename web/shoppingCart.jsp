                ...
                <%for (int i = 0; i < cart.size(); i++) {
                        ...
                        switch (bookType) {
                            case 1:
                                ...
                                <td><form method='POST' action='${pageContext.request.contextPath}/CartController'><input type='number' size='1' name='newQty' value=''/><input style='display:none;' type='text' name='index' value='<%out.print(counter); %>' size='1' /><input type='submit' name='action' value='Update' /></form>Max Qty: <%out.print(a.getNewQuantity());%></td>
